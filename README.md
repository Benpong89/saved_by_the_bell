...
SPLASH
search for volunteers by category or location
MAIN/INDEX
search for volunteers by category or location
list all volunteer profiles that match search parameters and are published
PROFILE EDIT/SHOW
users can edit their volunteer profile
Save draft
Publish for view
PROFILE VIEW PAGE/SHOW
View user profile that is published
